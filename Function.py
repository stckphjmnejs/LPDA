...
def menu_atack():
	...
	if user_input == '3':
		...
		print('        [\033[31mx\033[33m] choose VRT ')
		time.sleep(1)
		menu_atack()
...
def send_sms():
	check_os()
	phone = input('\n        write a russian number with a [\033[32m+7\033[33m]! \n\n        [\033[32m>>\033[33m] ')
...
def instruction():
	...
	user_input = input('\n        for exit write [\033[31m0\033[33m] \n\n        [\033[32m>>\033[33m] ')
...
def check_update():
    ...
    if updat_vers > float(version):
        print("\n        [\033[32m!\033[33m] we downloand update\n" + updat.text[0:6] + "\n        [\033[32m+\033[33m] redact:\n" + updat.text[7:])
        print("\n        [\033[32m!\033[33m] update downloanding please w8!")
        ...
        f.close()
        print('\n        [\033[32m+\033[33m] the file updated.')
        time.sleep(1)
        ...
        print("\n        [\033[32m!\033[33m] updated end. please reboot the bomber' [\033[32m!\033[33m]")
        time.sleep(1)
        sys.exit()

    elif updat_vers == float(version):
    	print("\n        [\033[32m!\033[33m] last updated.")

    elif updat_vers < float(version):
    	print("\n        [\033[32m!\033[33m] thanks. buy me again :)")
    	sys.exit()

    else:
    	print("\n        [\033[31mx\033[33m] error x3002  \n        try again and reconnect internet connection.")
...
def check_ins():
	if user_instruct == '0':
		print('        [\033[31m!\033[33m] u can write my requiements [\033[31m!\033[33m]')
	else:
		pass
...
def us_input():
	...
	if user_input == '0':
		...
		print('        [\033[31mx\033[33m] select the desired mode ')
		us_input()
	input()
...
def us_input_setting():
	...
	if user_setting == str(2):
	    kol2 =  input("\n        [\033[32m!\033[33m] write time no more 20 minutes ! \n\n        [\033[32m>>\033[33m] ")
	    effect(message1)
	    return user_setting
	...
	if user_setting == str(0):
		...
		print('\n        [\033[31mx\033[33m] select the desired mode!')
		us_input_setting()
...
def send_mail():
	...
	login = input('\n\n       select the desired mode [\033[32mTestmail347@gmail.com\033[33m]! \n\n        [\033[32m>>\033[33m]')
	password = input('\n\n        select the desired mode! \n\n        [\033[32m>>\033[33m]')
	url = input('\n\n      select the desired mode [\033[32msmtp.gmail.com\033[33m]! \n\n        [\033[32m>>\033[33m]')
	toaddr = input('\n\n       select the desired mode! \n\n        [\033[32m>>\033[33m]')
	topic = input('\n\n        select the desired mode! \n\n        [\033[32m>>\033[33m]')
	mess = input('\n\n       select the desired mode \n\n        [\033[32m>>\033[33m]')
	number_attack = input('\n\n        select the desired mode \n\n        [\033[32m>>\033[33m]')

	print('\n        [\033[32m!\033[33m] pls wait\n')
	time.sleep(2)
	...
	try:
		for value in range(int(number_attack)):
			...
			server.quit()
		print('        [\033[32m!\033[33m] attack end back to the menu [\033[32m3 сек.\033[33m]\n')
		time.sleep(3)
		start()
	except:
		print('        [\033[31mx\033[33m] error try again  X3004!\n')
		time.sleep(2)
		send_mail()
...
def ui_user_book():
    ...
    if menu == '2':
    	print('\n\n        [\033[31m!\033[33m] for changec number write a number !')
    	print('        [\033[31mx\033[33m] if you wanna exit please write >  [\033[31m0\033[33m] ! \n\n')
    	render_phones()
    ...
    if menu == '3':
    	render_phones()
    	print('\n\n        [\033[31mx\033[33m] for exit write [\033[31m0\033[33m] !')
    	menu_book = input('\n        [\033[32m>>\033[33m] ')
    ...
    if menu == "1":
        phones = input("\n        [\033[32m!\033[33m] write a number: ")
        phones_name = input("\n        [\033[32m!\033[33m] write a marker for number: ")
        file_phone = open('phone.data', 'a')
        file_phone.write(f'\n{phones} - {phones_name}')
        file_phone.close()
        print('\n        [\033[32m!\033[33m] number succeful addown!')
        time.sleep(1)
    else:
        print('        [\033[31mx\033[33m] select nD')
        ui_user_book()
...
def Setting():
	...
	print("        [\033[32m1\033[33m] creators")
